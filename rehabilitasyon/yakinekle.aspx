<%@ Page Title="Yakin Ekleme" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="yakinekle.aspx.cs" Inherits="yakinekle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <script type="text/javascript" src="Scripts/dropdown/dropdown.js"></script>
    ...
    <h1>Yakın Ekleme <asp:Label ID="mesaj" runat="server" Text=""></asp:Label></h1>      
  </div>
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <asp:Button ID="yakin_ekle" CssClass="btn btn-success"  runat="server" Text="Ekle" OnClick="yakin_ekle_Click" />
